...
//Pi = 3.1415926535;        //상수에 값을 재할당하면 에러발생
...
let x = 0,
  y = 0;
console.log(x++, ++y); //post-increment(조회 후 1증가), pre-increment(조회전 1증가)
console.log(x, y);
console.log(x--, --y); //post-decremnt, pre-decrement
console.log(x, y);
...
//자동 자료 변환
console.log("ABC" + 100 + true); //표현범위가 작은 것이 큰 쪽으로 자동 변환됨
