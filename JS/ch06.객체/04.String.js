...
//문자열 일부분(substring)
let today = new Date().toISOString(); //2024-07-19T02:12:23.710Z
console.log(today);
//날짜 추출//2024-07-19
console.log(today.substring(0, 10)); //시작점은 포함,끝점은 미포함 >> 0 ~ 9까지
//시간 추출//02:12:23
console.log(today.substring(11, 19)); //11에서 출발해서 8글자를 읽어옴(11 + 8)
console.log(new Date().toLocaleString()); //2024. 7. 19. 오전 11:20:24
console.log(new Date().toLocaleString().substring(16)); //16부터 끝까지
...
// 영문자와 공백만 남기고 모두 지움
console.log(sample.replace(/[^A-Z a-z]/g, "")); //^=아닌 것 g=모두
//한글과 공백만 남기고 모두 지움
